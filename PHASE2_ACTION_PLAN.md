...
- `SQUARE_APPLICATION_ID` = `[FROM_VERCEL_ENV]`
- `SQUARE_ACCESS_TOKEN` = `[FROM_VERCEL_ENV]`
- `STRIPE_SECRET_KEY` = `[FROM_VERCEL_ENV]`
- `STRIPE_WEBHOOK_SECRET` = `[FROM_VERCEL_ENV]`
- `GROK_API_KEY` = `[FROM_VERCEL_ENV]`
